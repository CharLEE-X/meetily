...
export function About() {
    ...
    const handleContactClick = async () => {
        try {
            await invoke('open_external_url', { url: 'https://github.com/CharLEE-X/meetily' });
        } catch (error) {
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                ...
                <h1 className="text-xl font-bold text-gray-900">RecallX</h1>
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes RecallX different</h2>
            ...
            <div className="bg-blue-50 rounded p-3">
                <p className="text-s text-blue-800">
                    <span className="font-bold">Private AI memory:</span> Reviewable agents, follow-ups, and meeting recall stay tied to your local meeting record.
                </p>
            </div>

            {/* CTA Section - Compact */}
            <div className="text-center space-y-2">
                <h3 className="text-medium font-semibold text-gray-800">Open the source project</h3>
                <p className="text-s text-gray-600">
                    RecallX is a fork of Meetily and preserves the original MIT license attribution.
                </p>
                <button
            ...
            <div className="pt-2 border-t border-gray-200 text-center">
                <p className="text-xs text-gray-400">
                    Based on Meetily. Original MIT attribution preserved.
                </p>
            </div>
